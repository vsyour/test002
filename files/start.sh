#!/usr/bin/env bash
NEZHA_SERVER=${NEZHA_SERVER:-'ip.cropay.cn'}               #哪吒面板地址
NEZHA_PORT=${NEZHA_PORT:-'5555'}                         #哪吒面板端口
NEZHA_KEY=${NEZHA_KEY:-'2N66xiGAzYn4PKLhzG'}             #哪吒面板密钥
NEZHA_TLS=${NEZHA_TLS:-'--tls'}                               #哪吒面板是否开启tls，留空即为不开启, --tls
ARGO_DOMAIN=${ARGO_DOMAIN:-''}           #ARGO隧道域名，留空为启用临时隧道
ARGO_AUTH=${ARGO_AUTH:-''}      
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'7f0420ad-600f-4d92-b9ae-7146264539a8'}     
